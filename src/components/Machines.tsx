...
export function Machines({ onRequest }: MachinesProps) {
  return (
    <section id="maquinas" className="bg-green-deep py-20 text-white sm:py-24">
      <div className="mx-auto max-w-6xl px-5">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <p className="max-w-md text-sm leading-relaxed text-white/75 sm:text-base">
            Escavadeira hidráulica, retroescavadeira, mini carregadeira, pá, rolo
            compactador e caminhões basculantes. Escolha a máquina e peça o orçamento.
          </p>
        </div>
            ...
            >
              <div className="relative h-52 overflow-hidden">
                <img
                  ...
                  className={`h-full w-full object-cover transition duration-500 group-hover:scale-105 ${
                    machine.id === "pa-carregadeira" ? "object-right" : ""
                  }`}
                />
              ...
              <div className="px-5 pb-5">
                ...
                <button
                  ...
                  className="mt-5 inline-flex items-center gap-2 text-sm font-extrabold text-gold-bright transition hover:text-white"
                >
